...
class VendorConfirmPledgeDialog extends StatefulWidget {
  final VoidCallback onConfirm;
  const VendorConfirmPledgeDialog({super.key, required this.onConfirm});

  @override
  State<VendorConfirmPledgeDialog> createState() => _VendorConfirmPledgeDialogState();
}

class _VendorConfirmPledgeDialogState extends State<VendorConfirmPledgeDialog> {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Checkbox 1
            _buildCheckboxRow(
              'عند البيع من التطبيق ',
              'التزم بدفع عمولة 1% على كل عملية بيع',
              isChecked1,
            ...
            // Checkbox 2
            _buildCheckboxRow(
              'عند البيع خارج التطبيق ',
              'إذا تعرفت على عميل من خلال التطبيق ثم بعت منه مستقبلا، أتعهد بدفع عمولة 1% عن كل عملية بيع.',
              isChecked2,
