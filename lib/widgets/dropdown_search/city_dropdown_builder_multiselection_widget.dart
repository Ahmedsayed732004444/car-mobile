...
class CityDropDownBuilderMultiSelectionWidget extends StatelessWidget {
  const CityDropDownBuilderMultiSelectionWidget({super.key, this.selectedItems, required this.hint});
  ...
  Widget build(BuildContext context) {
    ...
    return Wrap(
      children: [
        Text(
          selectedItems
              ?.map((e) => _isArabic ? e.cityNameAr : e.cityNameEn)
              .join(" - ") ?? "",
          style: TextStyle(
