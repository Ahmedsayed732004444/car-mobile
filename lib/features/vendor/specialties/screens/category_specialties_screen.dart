...
class CategorySpecialtiesScreen extends StatefulWidget {
  const CategorySpecialtiesScreen({super.key});

  @override
  State<CategorySpecialtiesScreen> createState() =>
      _CategorySpecialtiesScreenState();
}

class _CategorySpecialtiesScreenState extends State<CategorySpecialtiesScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<SpecialtyVendorProvider>(context, listen: false)
          .getCategoriesSpecialtyVendor(context);
    });
  }
    ...
    return Scaffold(
      ...
      body: _provider.isLoadingRefresh
        ...
        child: RefreshIndicator(
          onRefresh: (){
            return _provider.getCategoriesSpecialtyVendor(context);
          },
          child: ListView(
