...
class _HomeUserScreenState extends State<HomeUserScreen> {
  ...
  final List<FAQItemModel> _allFAQs = [
    ...
    FAQItemModel(
      ...
      answer: 'لإنشاء طلب جديد، اختر القسم المناسب (مثل قطع غيار، سيارات جديدة، عقارات...) ثم أدخل التفاصيل المطلوبة مثل المواصفات، الصور، ونطاق السعر. بعد ذلك يمكنك إرسال الطلب للشركات المؤهلة.',
    ),
    FAQItemModel(
